...
public class MenuBarLegendButtonController : MonoBehaviour
{
    [Inject]
    ...
    private void Start()
    {
        ...
        this.keywordToCommandService.Register(GetavizKeyword.LEGEND, this.OnInfoVoiceCommand);
    }
    ...
    private void TriggerInfo()
    {
        ...
        this.modelStateController.SwitchState(ModelState.LEGEND);
    }
}
